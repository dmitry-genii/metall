...
const blockData= document.querySelector("#block-data");
const blockOrders= document.querySelector("#block-orders");

btnData.addEventListener("click", function(){
	blockData.classList.remove('container__block-dis');
	blockOrders.classList.add('container__block-dis');
	btnData.classList.remove('container-block-btn__order-dis');
	btnOrders.classList.add('container-block-btn__order-dis');
})

btnOrders.addEventListener("click", function(){
	blockOrders.classList.remove('container__block-dis');
	blockData.classList.add('container__block-dis');
	btnOrders.classList.remove('container-block-btn__order-dis');
	btnData.classList.add('container-block-btn__order-dis');
})
